...
** Emacs
+ My recentf workflow interferes with my Docker workflow, because there will be quite a few non-existent connections hanging around and they will get triggered when I run consult-dir.
