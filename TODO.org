* TODO.org
** Code cleaning
+ I have a lot of common functionality that can be refactored in my hosts. Check which modules appear together a lot and see if we can bring them together in a sensible way.
