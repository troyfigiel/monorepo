...
with lib;
let
  cfg = config.localModules.polybar;
  ...
  offset = "3";
in {
  options.localModules.polybar.enable = mkEnableOption "polybar";
    ...
    services.polybar = {
      ...
      config = {
        ...
        "bar/bottom" = {
          ...
          font-1 =
            "Font Awesome 6 Free,Font Awesome 6 Free Solid:style=Solid;${offset}";
