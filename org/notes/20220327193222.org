:PROPERTIES:
:ID:       0abbfac1-b439-41e3-8de9-4d00eff960ce
:mtime:    20220409142844
:ctime:    20220327193222
:END:
#+title: Equipartition theorem
#+filetags: :stub:

The equipartition theorem is a key equation in [[id:e1359a2c-d435-4c73-b46f-3c3be387e889][Statistical physics]], describing how energy is
distributed among the microscopic degrees of freedom of a physical system. If the system has
[[id:a00e92f2-6cae-4515-bad8-264c6bc9dc55][Hamiltonian]] \( H \) with degrees of freedom \( x_n \), the equipartition theorem states that in
[[id:aa7c348b-b8ae-47b3-8de5-cf4600ac8a49][Thermal equilibrium]] we must find
...
An important special case arises when \( H \) is a [[id:dca3b8a7-3639-470f-9e2f-8736b4e2eda4][Homogeneous polynomial]] in its parameters. In
...
On physical grounds, [[id:99d2a8ad-3f01-445c-9942-523aee83c5de][The equipartition theorem for quadratic
degrees of freedom]]. This particular case sometimes also goes by the name of the equipartition theorem.

[[id:87f9320d-1ecc-46b2-b43f-75521f3187d4][The equipartition theorem is a purely classical result]].
